...
class EmpTestCase(BaseTest):
    ...
    def test_all_get_employee_with_limit_offset_query(self):
    ...
    def test_all_get_employee_with_name_query_200(self):
        self.client.post("/v1/employees", json={"name": "test", "gender": "男", "department": "图像组"})
        res = self.client.get("/v1/employees?name=test")
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.json["code"], 200)
        self.clean_redis_data()

    def test_all_get_employee_with_name_query_404(self):
        res = self.client.get("/v1/employees?name=testnot")
        self.assertEqual(res.status_code, 404)
        self.assertEqual(res.json["code"], 404)
        self.clean_redis_data()

    def test_all_get_employee_with_gender_query(self):
        res = self.client.get("/v1/employees?gender=男")
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.json["code"], 200)
        self.clean_redis_data()

    def test_all_get_employee_with_department_query(self):
        res = self.client.get("/v1/employees?department=web开发组")
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.json["code"], 200)
        self.clean_redis_data()
    ...
    def test_get_single_employee_with_200(self):
        res = self.client.get("/v1/employees/1")
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.json["code"], 200)
        self.clean_redis_data()

    def test_get_single_employee_with_404(self):
    ...
    def test_update_employee_with_200(self):
        res = self.client.put("/v1/employees/1", json={"name": "test11", "gender": "男", "department": "web开发组"})
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.json["code"], 200)
        self.clean_redis_data()

    def test_update_employee_with_415(self):
        res = self.client.put("/v1/employees/1", json={})
        self.assertEqual(res.status_code, 415)
        self.assertEqual(res.json["code"], 415)
        self.clean_redis_data()

    def test_update_employee_with_400_1(self):
    ...
    def test_update_employee_with_400_2(self):
        res = self.client.put("/v1/employees/1", json={"name": "test", "gender": "男", "department": "test"})
        self.assertEqual(res.status_code, 400)
        self.assertEqual(res.json["code"], 400)
        self.assertTrue("不存在" in res.json["msg"])
        self.clean_redis_data()

    def test_delete_employee_with_200(self):
